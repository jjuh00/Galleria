...
const Galleria = () => {
    ...
    const uusinKuva = kuvat.slice(alkuIndex, alkuIndex + kuviaSivulla); //Tämänhetkinen kuva
    ...
    return (
        //Otsikon tyylitys
        <div className="container-fluid px-5 bg-light d-flex flex-column">
            <div className="row">
                <div className="col">
            ...
            {/*Kuvien tyylitys. Jos ollaan viimeisellä sivulla, keskitetään sivulla olevat 3 kuvaa*/}
            ...
            <div className="row mt-auto pb-3">
